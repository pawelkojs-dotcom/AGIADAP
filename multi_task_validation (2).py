...
TASK_SCENARIOS = [
    ...
    TaskScenario(
        task_id="C4",
        task_type="creative",
        description="Design novel game mechanics using Ïƒ-Î˜-Î³ dynamics",
...
class MultiTaskValidator:
    ...
    def generate_config_for_task(self, task: TaskScenario) -> Dict[str, Any]:
        ...
        # These are empirically validated from Campaigns #3-4
    ...
    def validate_task(self, task: TaskScenario, config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if self.enable_safety:
            try:
                ...
                # Safety violation - return failed result
                return {
                    ...
                    'sigma_coh': 0.0,
                    'I_strength': 0.0,
                    'reasoning': f"Safety violation: {e}",
                    'cost': 0.0
                }
    ...
    def run_validation(
        ...
        for task in tasks:
            ...
            for run in range(runs_per_task):
                ...
                success_marker = "âœ“" if result['task_success'] else "âœ—"
...
def main():
    ...
    validator = MultiTaskValidator(evaluator, enable_safety_phase2=enable_phase2)
    
    # Print safety status
    if enable_phase2:
        print("\n" + "="*60)
        print("Safety Phase 2 (H5-medium) ENABLED")
        print("="*60 + "\n")
    ...
    print(f"\nâœ… TRL 3.2 Multi-Task Validation COMPLETE!")
